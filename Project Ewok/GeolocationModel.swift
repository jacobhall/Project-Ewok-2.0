...
public class GeolocationModel{
    ...
    var averageRating: Double;       //The average rating of the geolocation
    ...
    //Constructors
    init(geolocationID: Int, latitude: Double, longitude: Double, name: String, description: String? = nil, averageRating: Double, locationID: Int? = nil, locationType: String? = nil){
